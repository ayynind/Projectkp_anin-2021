...
!(function(a) {
  ...
  (a.fn.tooltip.defaults = { animation: !0, placement: "top", selector: !1, template: '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover", title: "", delay: 0, html: !1 }),
  ...
  b.prototype = {
    ...
    lookup: function(b) {
      var c;
      return (
        (this.query = this.$element.val()), !this.query || this.query.length < this.options.minLength ? (this.shown ? this.hide() : this) : ((c = a.isFunction(this.source) ? this.source(this.query, a.proxy(this.process, this)) : this.source), c ? this.process(c) : this)
      );
    },
    process: function(b) {
      var c = this;
