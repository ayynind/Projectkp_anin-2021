  ...
  e(document).mouseup(function () {
    ...
    e.widget("ui.mouse", {
      ...
      _mouseMove: function (t) {
        return e.ui.ie && (!document.documentMode || document.documentMode < 9) && !t.button
          ? this._mouseUp(t)
          : this._mouseStarted
  ...
  e.widget("ui.autocomplete", {
    ...
    _create: function () {
      ...
      (this.isMultiLine = s ? !0 : o ? !1 : this.element.prop("isContentEditable")),
        ...
        this._initSource(),
        (this.menu = e("<ul>").addClass("ui-autocomplete ui-front").appendTo(this._appendTo()).menu({ input: e(), role: null }).hide().data("ui-menu")),
  ...
  function o(t) {
    ...
    return t
      ...
      .delegate(n, "mouseover", function () {
        e.datepicker._isDisabledDatepicker(i.inline ? t.parent()[0] : i.input[0]) ||
  ...
  e.extend(s.prototype, {
        ...
        (i = this._get(n, "buttonText")),
          ...
          (n.trigger = e(
            this._get(n, "buttonImageOnly")
              ? e("<img/>").addClass(this._triggerClass).attr({ src: s, alt: i, title: i })
    ...
    _destroyDatepicker: function (t) {
      ...
      (r = t.nodeName.toLowerCase()),
        e.removeData(t, n),
        r === "input"
          ? (s.append.remove(), s.trigger.remove(), i.removeClass(this.markerClassName).unbind("focus", this._showDatepicker).unbind("keydown", this._doKeyDown).unbind("keypress", this._doKeyPress).unbind("keyup", this._doKeyUp))
          : (r === "div" || r === "span") && i.removeClass(this.markerClassName).empty();
    },
    ...
    _showDatepicker: function (t) {
      ...
      u(n.settings, i),
        ...
        n.dpDiv.css({ position: e.datepicker._inDialog && e.blockUI ? "static" : s ? "fixed" : "absolute", display: "none", left: o.left + "px", top: o.top + "px" }),
        n.inline ||
    ...
    _generateHTML: function (e) {
      ...
      (e.drawMonth = Z),
        ...
        (r = this._canAdjustMonth(e, -1, et, Z)
          ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (U ? "e" : "w") + "'>" + n + "</span></a>"
          : W
          ? ""
          : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (U ? "e" : "w") + "'>" + n + "</span></a>"),
        ...
        (s = this._canAdjustMonth(e, 1, et, Z)
          ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (U ? "w" : "e") + "'>" + i + "</span></a>"
          : W
          ? ""
          : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (U ? "w" : "e") + "'>" + i + "</span></a>"),
        ...
        (f = z
          ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" +
            (U ? a : "") +
            (this._isInRange(e, u) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + o + "</button>" : "") +
            (U ? "" : a) +
            "</div>"
          : ""),
      ...
      for (S = 0; S < V[0]; S++) {
        ...
        for (T = 0; T < V[1]; T++) {
          ...
          (k +=
            ...
            this._generateMonthYearHeader(e, Z, et, G, Y, S > 0 || T > 0, d, v) +
            ...
            for (E = 0; E < 7; E++)
              (j = m ? m.apply(e.input ? e.input[0] : null, [P]) : [!0, ""]),
                ...
                (B +=
                  ...
                  ((P.getTime() === N.getTime() && Z === e.selectedMonth && e._keyEvent) || (b.getTime() === P.getTime() && b.getTime() === N.getTime()) ? " " + this._dayOverClass : "") +
                  (I ? " " + this._unselectableClass + " ui-state-disabled" : "") +
                  (F && !g ? "" : " " + j[1] + (P.getTime() === Q.getTime() ? " " + this._currentClass : "") + (P.getTime() === R.getTime() ? " ui-datepicker-today" : "")) +
                  "'" +
                  ((!F || g) && j[2] ? " title='" + j[2].replace(/'/g, "&#39;") + "'" : "") +
                  (I ? "" : " data-handler='selectDay' data-event='click' data-month='" + P.getMonth() + "' data-year='" + P.getFullYear() + "'") +
                  ">" +
                  (F && !g
                    ? "&#xa0;"
                    : I
                    ? "<span class='ui-state-default'>" + P.getDate() + "</span>"
                    : "<a class='ui-state-default" +
                      (P.getTime() === R.getTime() ? " ui-state-highlight" : "") +
    ...
    _isInRange: function (e, t) {
      ...
      return (
        a && ((n = a.split(":")), (r = new Date().getFullYear()), (o = parseInt(n[0], 10)), (u = parseInt(n[1], 10)), n[0].match(/[+\-].*/) && (o += r), n[1].match(/[+\-].*/) && (u += r)),
  ...
  e.widget("ui.dialog", {
    ...
    _setOption: function (e, t) {
      ...
      this._super(e, t),
        ...
        e === "closeText" && this.uiDialogTitlebarClose.button({ label: "" + t }),
    ...
    _size: function () {
      ...
      this.element.show().css({ width: "auto", minHeight: 0, maxHeight: "none", height: 0 }),
        ...
        r.height === "auto" ? this.element.css({ minHeight: t, maxHeight: n, height: "auto" }) : this.element.height(Math.max(0, r.height - e)),
...
(function (e, t) {
  e.widget("ui.draggable", e.ui.mouse, {
    ...
    _mouseCapture: function (t) {
      var n = this.options;
      return this.helper || n.disabled || e(t.target).closest(".ui-resizable-handle").length > 0
        ? !1
    ...
    _mouseStop: function (t) {
      ...
      return !i && this.options.helper === "original"
        ? !1
        : ((this.options.revert === "invalid" && !s) || (this.options.revert === "valid" && s) || this.options.revert === !0 || (e.isFunction(this.options.revert) && this.options.revert.call(this.element, s))
    ...
    _setContainment: function () {
      ...
      if (i.containment === "document" || i.containment === "window")
        this.containment = [
          i.containment === "document" ? 0 : e(window).scrollLeft() - this.offset.relative.left - this.offset.parent.left,
          i.containment === "document" ? 0 : e(window).scrollTop() - this.offset.relative.top - this.offset.parent.top,
          (i.containment === "document" ? 0 : e(window).scrollLeft()) + e(i.containment === "document" ? document : window).width() - this.helperProportions.width - this.margins.left,
          (i.containment === "document" ? 0 : e(window).scrollTop()) + (e(i.containment === "document" ? document : window).height() || document.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top,
        ];
    ...
    _generatePosition: function (t) {
      ...
      return (
        this.originalPosition &&
          (this.containment &&
            (this.relative_container ? ((r = this.relative_container.offset()), (n = [this.containment[0] + r.left, this.containment[1] + r.top, this.containment[2] + r.left, this.containment[3] + r.top])) : (n = this.containment),
    ...
    e.ui.plugin.add("draggable", "scroll", {
      ...
      drag: function (t) {
        ...
        if (n.scrollParent[0] !== document && n.scrollParent[0].tagName !== "HTML") {
          if (!r.axis || r.axis !== "x")
            n.overflowOffset.top + n.scrollParent[0].offsetHeight - t.pageY < r.scrollSensitivity
              ? (n.scrollParent[0].scrollTop = i = n.scrollParent[0].scrollTop + r.scrollSpeed)
              : t.pageY - n.overflowOffset.top < r.scrollSensitivity && (n.scrollParent[0].scrollTop = i = n.scrollParent[0].scrollTop - r.scrollSpeed);
          if (!r.axis || r.axis !== "y")
            n.overflowOffset.left + n.scrollParent[0].offsetWidth - t.pageX < r.scrollSensitivity
              ...
              : t.pageX - n.overflowOffset.left < r.scrollSensitivity && (n.scrollParent[0].scrollLeft = i = n.scrollParent[0].scrollLeft - r.scrollSpeed);
        } else {
          if (!r.axis || r.axis !== "x")
            t.pageY - e(document).scrollTop() < r.scrollSensitivity
              ? (i = e(document).scrollTop(e(document).scrollTop() - r.scrollSpeed))
              : e(window).height() - (t.pageY - e(document).scrollTop()) < r.scrollSensitivity && (i = e(document).scrollTop(e(document).scrollTop() + r.scrollSpeed));
          if (!r.axis || r.axis !== "y")
            t.pageX - e(document).scrollLeft() < r.scrollSensitivity
              ? (i = e(document).scrollLeft(e(document).scrollLeft() - r.scrollSpeed))
              : e(window).width() - (t.pageX - e(document).scrollLeft()) < r.scrollSensitivity && (i = e(document).scrollLeft(e(document).scrollLeft() + r.scrollSpeed));
        }
                ...
                s.fn[t] = function (s) {
                  ...
                  return o === "undefined"
                    ...
                    : (o === "function" && ((s = s.call(this, f)), (o = e.type(s))),
                      s == null && i.empty ? this : (o === "string" && ((l = r.exec(s)), l && (s = f + parseFloat(l[2]) * (l[1] === "+" ? 1 : -1))), (a[i.idx] = s), this[u](a)));
                };
              });
          }),
          (s.hook = function (t) {
        ...
        this._on({
          ...
          "click .ui-menu-item:has(a)": function (t) {
            ...
            !this.mouseHandled &&
              ...
              ((this.mouseHandled = !0),
              this.select(t),
              n.has(".ui-menu").length ? this.expand(t) : this.element.is(":focus") || (this.element.trigger("focus", [!0]), this.active && this.active.parents(".ui-menu").length === 1 && clearTimeout(this.timer)));
          },
...
(function (e, t) {
  ...
  e.widget("ui.resizable", e.ui.mouse, {
    ...
    _destroy: function () {
      ...
      return (
        this.elementIsWrapper &&
          (n(this.element), (t = this.element), this.originalElement.css({ position: t.css("position"), width: t.outerWidth(), height: t.outerHeight(), top: t.css("top"), left: t.css("left") }).insertAfter(t), t.remove()),
    ...
    _mouseStart: function (t) {
      ...
      return (
        (this.resizing = !0),
        /absolute/.test(a.css("position")) ? a.css({ position: "absolute", top: a.css("top"), left: a.css("left") }) : a.is(".ui-draggable") && a.css({ position: "absolute", top: u.top, left: u.left }),
        this._renderProxy(),
    ...
    e.ui.plugin.add("resizable", "containment", {
      ...
      resize: function (t) {
        ...
        h[0] !== document && /static/.test(h.css("position")) && (c = a),
          f.left < (o._helper ? a.left : 0) &&
            ((o.size.width = o.size.width + (o._helper ? o.position.left - a.left : o.position.left - c.left)), l && (o.size.height = o.size.width / o.aspectRatio), (o.position.left = u.helper ? a.left : 0)),
      ...
      stop: function () {
        ...
        t._helper && !n.animate && /relative/.test(s.css("position")) && e(this).css({ left: u.left - i.left - r.left, width: a, height: f }),
          t._helper && !n.animate && /static/.test(s.css("position")) && e(this).css({ left: u.left - i.left - r.left, width: a, height: f });
      },
    }),
    ...
    e.ui.plugin.add("resizable", "ghost", {
      start: function () {
        ...
        (t.ghost = t.originalElement.clone()),
          t.ghost
            .css({ opacity: 0.25, display: "block", position: "relative", height: r.height, width: r.width, margin: 0, left: 0, top: 0 })
      ...
      resize: function () {
        ...
        (n.grid = u),
          ...
          /^(se|s|e)$/.test(o)
            ...
            : /^(sw)$/.test(o)
            ? ((t.size.width = h), (t.size.height = p), (t.position.left = s.left - l))
            : ((t.size.width = h), (t.size.height = p), (t.position.top = s.top - c), (t.position.left = s.left - l));
      },
    });
})(jQuery);
(function (e, t) {
      ...
      return (
        ...
        this.selectees.each(function () {
          ...
          i.tolerance === "touch" ? (f = !(n.left > u || n.right < s || n.top > a || n.bottom < o)) : i.tolerance === "fit" && (f = n.left > s && n.right < u && n.top > o && n.bottom < a),
            f
              ? (n.selected && (n.$element.removeClass("ui-selected"), (n.selected = !1)),
                n.unselecting && (n.$element.removeClass("ui-unselecting"), (n.unselecting = !1)),
                n.selecting || (n.$element.addClass("ui-selecting"), (n.selecting = !0), r._trigger("selecting", t, { selecting: n.element })))
              : (n.selecting &&
                  ((t.metaKey || t.ctrlKey) && n.startselected
                    ? (n.$element.removeClass("ui-selecting"), (n.selecting = !1), n.$element.addClass("ui-selected"), (n.selected = !0))
                    : (n.$element.removeClass("ui-selecting"), (n.selecting = !1), n.startselected && (n.$element.addClass("ui-unselecting"), (n.unselecting = !0)), r._trigger("unselecting", t, { unselecting: n.element }))),
                n.selected &&
                  !t.metaKey &&
                  !t.ctrlKey &&
                  !n.startselected &&
                  (n.$element.removeClass("ui-selected"), (n.selected = !1), n.$element.addClass("ui-unselecting"), (n.unselecting = !0), r._trigger("unselecting", t, { unselecting: n.element })));
        }),
        !1
      );
    },
  ...
  e.widget("ui.slider", e.ui.mouse, {
        ...
        : ((this.elementSize = { width: this.element.outerWidth(), height: this.element.outerHeight() }),
          ...
          u === !1
            ...
            : ((this._mouseSliding = !0),
              ...
              (this._clickOffset = f
                ? { left: 0, top: 0 }
                : { left: t.pageX - a.left - s.width() / 2, top: t.pageY - a.top - s.height() / 2 - (parseInt(s.css("borderTopWidth"), 10) || 0) - (parseInt(s.css("borderBottomWidth"), 10) || 0) + (parseInt(s.css("marginTop"), 10) || 0) }),
    ...
    _setOption: function (t, n) {
      ...
      t === "range" &&
        ...
        (n === "min" ? ((this.options.value = this._values(0)), (this.options.values = null)) : n === "max" && ((this.options.value = this._values(this.options.values.length - 1)), (this.options.values = null))),
        ...
        this.options.scroll &&
          (this.scrollParent[0] !== document && this.scrollParent[0].tagName !== "HTML"
            ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - t.pageY < o.scrollSensitivity
                ...
                : t.pageY - this.overflowOffset.top < o.scrollSensitivity && (this.scrollParent[0].scrollTop = u = this.scrollParent[0].scrollTop - o.scrollSpeed),
              this.overflowOffset.left + this.scrollParent[0].offsetWidth - t.pageX < o.scrollSensitivity
                ...
                : t.pageX - this.overflowOffset.left < o.scrollSensitivity && (this.scrollParent[0].scrollLeft = u = this.scrollParent[0].scrollLeft - o.scrollSpeed))
            : (t.pageY - e(document).scrollTop() < o.scrollSensitivity
                ? (u = e(document).scrollTop(e(document).scrollTop() - o.scrollSpeed))
                : e(window).height() - (t.pageY - e(document).scrollTop()) < o.scrollSensitivity && (u = e(document).scrollTop(e(document).scrollTop() + o.scrollSpeed)),
              t.pageX - e(document).scrollLeft() < o.scrollSensitivity
                ? (u = e(document).scrollLeft(e(document).scrollLeft() - o.scrollSpeed))
                : e(window).width() - (t.pageX - e(document).scrollLeft()) < o.scrollSensitivity && (u = e(document).scrollLeft(e(document).scrollLeft() + o.scrollSpeed))),
    ...
    _refreshItems: function (t) {
      ...
      if (h && this.ready)
        for (n = h.length - 1; n >= 0; n--) {
          ...
          for (r = i.length - 1; r >= 0; r--)
            (s = e.data(i[r], this.widgetFullName)),
              s && s !== this && !s.options.disabled && (c.push([e.isFunction(s.options.items) ? s.options.items.call(s.element[0], t, { item: this.currentItem }) : e(s.options.items, s.element), s]), this.containers.push(s));
        }
          ...
          (r.placeholder = {
            element: function () {
              var r = e(document.createElement(t.currentItem[0].nodeName))
                .addClass(n || t.currentItem[0].className + " ui-sortable-placeholder")
    ...
    _setContainment: function () {
      ...
      if (i.containment === "document" || i.containment === "window")
        this.containment = [
          ...
          e(i.containment === "document" ? document : window).width() - this.helperProportions.width - this.margins.left,
          (e(i.containment === "document" ? document : window).height() || document.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top,
        ];
